...
🔹 ORM - Associations 1:1 e 1:N <br>
🔹 ORM - Associations N:N e Transactions <br>
...
1. Clone o repositório com o comando: `git clone git@github.com:aimemartins/project-blogs-api.git`
2. Entre na pasta do repositório que você acabou de clonar: `cd project-blogs-api`
